...
<body>
    ...
    <div class="modal fade" id="supprimerPV" tabindex="-1" aria-labelledby="supprimerPVLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form runat="server">
                    <div class="modal-header">
                        <h5 class="modal-title" id="supprimerPVLabel">Supprimer PV</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group ">
                            <label for="id_PV" class="form-label">ID du PV</label>
                            <div class="input-group">
                                <input type="text" class="form-control" id="id_PV" name="id_PV" readonly="readonly" value="" />
                            </div>
                        </div>
